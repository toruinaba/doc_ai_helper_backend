...
async def test_service_resolver():
    ...
    print(f"GitHub supported: {GitServiceResolver.is_service_supported(GitServiceType.GITHUB)}")
    print(f"Forgejo supported: {GitServiceResolver.is_service_supported(GitServiceType.FORGEJO)}")
