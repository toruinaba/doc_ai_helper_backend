...
class CredentialManager:
    ...
    def get_credentials(cls, context: RepositoryContext) -> Dict[str, Any]:
        ...
        if context.service_type == GitServiceType.GITHUB:
            ...
            raise AuthenticationError(
                f"サポートされていないサービス: {context.service_type.value}"
            )
    ...
    def _get_github_credentials(cls) -> Dict[str, Any]:
        ...
        return {"access_token": token, "service_type": "github"}
    ...
    def get_supported_services(cls) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "forgejo": {
                ...
                "required_env_vars": [
                    "FORGEJO_TOKEN または FORGEJO_USERNAME + FORGEJO_PASSWORD"
                ],
                "optional_env_vars": [
                    "FORGEJO_TOKEN_<DOMAIN>",
                    "FORGEJO_USERNAME_<DOMAIN>",
                    "FORGEJO_PASSWORD_<DOMAIN>",
                ],
                "example_env_vars": {
    ...
    def validate_environment(cls) -> Dict[str, bool]:
        ...
        forgejo_configured = bool(
            ...
            or (os.getenv("FORGEJO_USERNAME") and os.getenv("FORGEJO_PASSWORD"))
        )
