    ...
    async def create_pull_request(
        ...
        **kwargs,
        ...
        try:
            ...
            async with self.forgejo_service.get_async_client() as client:
                url = (
                    f"{self.forgejo_service.base_url}/api/v1/repos/{owner}/{repo}/pulls"
                )
            ...
            raise GitServiceException(
                f"Failed to create Forgejo pull request: {str(e)}"
            )
        ...
        try:
            ...
            async with self.forgejo_service.get_async_client() as client:
                ...
                if response.status_code == 200:
                    ...
                    raise GitServiceException(
                        f"Failed to check permissions: {response.text}"
                    )
            ...
            raise GitServiceException(
                f"Failed to check Forgejo repository permissions: {str(e)}"
            )
