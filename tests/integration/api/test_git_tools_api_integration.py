...
class TestAPIGitToolsIntegration:
    ...
    async def test_llm_query_with_git_issue_creation(self):
        ...
        with patch(
            "doc_ai_helper_backend.services.llm.openai_service.OpenAIService.query"
        ) as mock_query, patch(
    ...
    async def test_llm_stream_with_git_pr_creation(self):
        ...
        with patch(
            "doc_ai_helper_backend.services.llm.openai_service.OpenAIService.stream_query"
    ...
    async def test_configuration_based_service_selection(self):
        ...
        with patch(
            "doc_ai_helper_backend.services.mcp.tools.git_tools._default_service",
            "forgejo",
        ), patch(
            "doc_ai_helper_backend.services.mcp.tools.git_tools.create_git_issue"
        ) as mock_create_issue:
            ...
            mock_create_issue.return_value = (
                "Issue created successfully on Forgejo: #42"
            )
    ...
    async def test_runtime_credentials_override_configuration(self):
        ...
        with patch(
            ...
            mock_create_issue.return_value = (
                "Issue created with runtime credentials: #999"
            )
