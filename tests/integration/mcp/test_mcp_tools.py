...
class TestMCPToolsIntegration:
    ...
    async def test_document_tools_integration(
        ...
        assert "heading_levels" in structure_result or "total_headings" in structure_result
    ...
    async def test_utility_tools_integration(self, mcp_server: DocumentAIHelperMCPServer):
        """Utility toolsの統合テスト。"""
        ...
        # Test format_text
        format_result_upper = await format_text(
            text="hello world",
            style="uppercase"
        )
        ...
        format_result_title = await format_text(
            text="hello world",
            style="title"
        )
    ...
    async def test_github_tools_integration(self, mcp_server_with_github: DocumentAIHelperMCPServer):
        """GitHub toolsの統合テスト（GitHub token必要）。"""
        # GitHub tools not implemented yet
        pytest.skip("GitHub tools not implemented yet")

    async def test_github_tools_mock_integration(self, mcp_server: DocumentAIHelperMCPServer):
