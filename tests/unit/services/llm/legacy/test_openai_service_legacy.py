...
These tests are for the old modular OpenAI service implementation that was
refactored to use composition pattern. They are kept for historical reference
but are expected to fail as the old modules have been moved to legacy/ directory.

For current tests, see: tests/unit/services/llm/test_openai_service.py
...
pytestmark = pytest.mark.skip(
    reason="Legacy tests for old modular architecture - use composition-based tests instead"
)
