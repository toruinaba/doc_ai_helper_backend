...
class TestMCPGitToolsFactory:
    ...
    @patch.dict(
        os.environ,
        {"FORGEJO_BASE_URL": "http://localhost:3000", "FORGEJO_TOKEN": "env_token"},
    )
    ...
    def test_create_from_repository_context_github(self):
        ...
        adapter = MCPGitToolsFactory.create_from_repository_context(
            context, config={"access_token": "test_token"}
        )
    ...
    def test_create_from_repository_context_missing_service(self):
        ...
        with pytest.raises(
            ValueError, match="Repository context must contain 'service' field"
        ):
    ...
    def test_register_adapter_invalid_type(self):
        ...
        with pytest.raises(
            TypeError, match="Adapter class must inherit from MCPGitToolsBase"
        ):
    ...
    def test_create_github_adapter_kwargs_only(self):
        ...
        adapter = MCPGitToolsFactory.create("github", access_token="kwargs_token")
    ...
    def test_create_forgejo_adapter_kwargs_only(self):
        ...
        adapter = MCPGitToolsFactory.create(
            "forgejo", base_url="http://localhost:3000", access_token="kwargs_token"
        )
...
class TestConvenienceFunctions:
    ...
    def test_create_forgejo_tools(self):
        ...
        adapter = create_forgejo_tools(
            base_url="http://localhost:3000", access_token="test_token"
        )
    ...
    def test_create_forgejo_tools_basic_auth(self):
        ...
        adapter = create_forgejo_tools(
            base_url="http://localhost:3000", username="testuser", password="testpass"
        )
