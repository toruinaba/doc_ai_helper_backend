...
class TestMCPGitToolsBase:
    ...
    async def test_create_issue_success(
        self, git_tools, mock_client, repository_context
    ):
    ...
    async def test_create_issue_repository_access_validation(
        self, git_tools, repository_context
    ):
    ...
    async def test_check_repository_permissions_success(
        self, git_tools, mock_client, repository_context
    ):
    ...
    async def test_client_exception_handling(
        self, git_tools, mock_client, repository_context
    ):
    ...
    def test_validate_repository_access_same_repo(self, git_tools):
        ...
        repo_context = RepositoryContext(
            service="github", owner="testuser", repo="test-repo", ref="main"
        )
