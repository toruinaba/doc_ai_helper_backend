    ...
    async def test_calculation_tool(self):
        ...
        if result.get('tool_execution_results'):
            ...
            for tool_result in result['tool_execution_results']:
                print(f"  - {tool_result['function_name']}: {tool_result.get('result', tool_result.get('error'))}")
...
"""
    ...
    async def run_all_tests(self):
        ...
        try:
            ...
            print("   python -m doc_ai_helper_backend.main を実行してサーバーを起動してください")
